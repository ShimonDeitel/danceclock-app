...
/// Danceclock's own identity: a palette built specifically for this app's
/// domain, not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.07, green: 0.05, blue: 0.09)
    static let card = Color.white
    static let cardBorder = Color(red: 0.65, green: 0.25, blue: 0.85).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 0.65, green: 0.25, blue: 0.85)
    static let accentDeep = Color(red: 0.65, green: 0.25, blue: 0.85).opacity(0.75)
